      ...
      <main>
        <section className="my-8">
          <Card>
            ...
            <CardContent>
              <Image src="/images/proa_boat_intro.jpg" alt="Proa Boat Introduction" width={600} height={400} className="my-4 mx-auto" />
              <p>
        ...
        <section className="my-8">
          <Card>
            ...
            <CardContent>
              <Image src="/images/proa_boat_history.jpg" alt="Proa Boat History" width={600} height={400} className="my-4 mx-auto" />
              <p>
